...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="admin_list.do">后台管理</a></li>
 ...
 <div class="row">
    ...
    <div class="box box-primary" style="margin-top:10px;">
      ...
      <!-- form start -->
      <form role="form" action="/PAS/admin/manager/doupdate" method="post" style="padding-top: 10px;">
        <div class="box-body">
          <div class="form-group">
            <label for="exampleInputEmail1">管理员名称</label>
            <input type="text" class="form-control" name="admin_name" id="admin_name" value="${admin.admin_name}" required placeholder="管理员名称">
          </div>
          <div class="form-group">
        ...
        <!-- /.box-body -->
        <input type="hidden" id="id" name="id" value="${admin.a_id}" />
