      ...
      <form role="form" action="DoGoods_update.do" method="post" style="padding-top: 10px;">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="goods_name" id="goods_name" value="${goods.goods_name}" required placeholder="商品名称">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">商品详情</label>
            <textarea class="form-control" required name="goods_main" id="goods_main" placeholder="商品详情">${goods.goods_main}</textarea>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">商品价格</label>
            <div class="input-group">
                <span class="input-group-addon">¥</span>
                <input type="text" name="price" required id="price" value="${goods.price}" class="form-control">
              </div>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">商品数量</label>
            <input type="text" class="form-control" required name="total" value="${goods.total}" id="total" placeholder="商品数量">
          </div>
         <input type="hidden" name="goods_type" id="goods_type" value="${goods.goods_type}" />
